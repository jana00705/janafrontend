<template>
  ...
  <div>
         <b-form-group  label="First Name" label-for="firstname">
          <b-form-input id="firstname" name="firstname"
       ...
       <b-form-group  label="Last Name" label-for="lastname">
          <b-form-input id="lastname" name="lastname"
          v-model.trim="$v.student.lastname.$model" 
          :class="{'is-invalid':$v.student.lastname.$error, 
          'is-valid':!$v.student.lastname.$invalid}"
         > </b-form-input>
         <div class="valid-feedback">Your First Name is Valid!</div>
            <div class="invalid-feedback">
                <span v-if="!$v.student.lastname.required">First Name is required</span>
            </div>
         </b-form-group>
        ...
        <b-form-group label="Phone Number" label-for="studentnumber">
          <b-form-input id="studentnumber"
          name="studentnumber"
          type="number"
          v-model.trim="$v.student.phone.$model" :class="{'is-invalid':$v.student.phone.$error, 'is-valid':!$v.student.phone.$invalid}"
         > </b-form-input>
         <div class="valid-feedback">Your number is valid!</div>
            <div class="invalid-feedback">
                <span v-if="!$v.student.phone.required">Phone number is required</span>
            </div>
         </b-form-group>
